...
namespace calculation {
    ...
    public:
        ...
        static Sector* getNearestSector(Point point, const SectorBunch& sectorBunch);
        static std::vector<Sector*> getNearestSectors(FlightFrame flightFrame, const SectorBunch& sectorBunch);
